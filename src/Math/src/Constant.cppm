export module DEngine.Math.Constant;

namespace DEngine::Math::impl {
	template<typename T>
...
export namespace DEngine::Math {
	constexpr auto e = impl::e<float>;

	constexpr auto goldenRatio = impl::goldenRatio<float>;

	constexpr auto pi = impl::pi<float>;
	constexpr auto degToRad = impl::degToRad<float>;
	constexpr auto radToDeg = impl::radToDeg<float>;
}
