...
export module DEngine.Std.Array;
...
export namespace DEngine::Std {
	...
	public:
		...
		[[nodiscard]] constexpr Std::Span<T> ToSpan() noexcept;
		[[nodiscard]] constexpr Std::Span<T const> ToSpan() const noexcept;
		...
		[[nodiscard]] constexpr bool operator==(Array const& other) const
			requires(Trait::EqualityComparable<T>)
		{
