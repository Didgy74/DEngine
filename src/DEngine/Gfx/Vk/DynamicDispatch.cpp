...
vk::Result DEngine::Gfx::Vk::DeviceDispatch::allocateCommandBuffers(
...
vk::Result DEngine::Gfx::Vk::DeviceDispatch::allocateDescriptorSets(
...
vk::DeviceMemory DEngine::Gfx::Vk::DeviceDispatch::allocateMemory(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorInvalidOpaqueCaptureAddressKHR:
		throw std::runtime_error("Unable to allocate vk::DeviceMemory");
	default:
		break;
	}
	return temp;
...
void DEngine::Gfx::Vk::DeviceDispatch::beginCommandBuffer(
	...
	vk::CommandBufferBeginInfo const& beginInfo) const
{
	...
	if (result != vk::Result::eSuccess)
		throw std::runtime_error("Unable to begin vk::CommandBuffer");
}

void DEngine::Gfx::Vk::DeviceDispatch::cmdCopyBufferToImage(
	vk::CommandBuffer cmdBuffer,
	vk::Buffer srcBuffer,
	vk::Image dstImage,
...
[[nodiscard]] vk::CommandPool DEngine::Gfx::Vk::DeviceDispatch::createCommandPool(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorOutOfHostMemory:
	case vk::Result::eErrorOutOfDeviceMemory:
		throw std::runtime_error("Unable to create vk::CommandPool.");
	default:
		break;
	}
	return temp;
...
vk::DescriptorPool DEngine::Gfx::Vk::DeviceDispatch::createDescriptorPool(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorFragmentationEXT:
		throw std::runtime_error("Unable to create vk::DescriptorPool.");
	default:
		break;
	}
	return temp;
...
vk::DescriptorSetLayout DEngine::Gfx::Vk::DeviceDispatch::createDescriptorSetLayout(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorOutOfHostMemory:
	case vk::Result::eErrorOutOfDeviceMemory:
		throw std::runtime_error("Unable to create vk::DescriptorSetLayout.");
	default:
		break;
	}
	return temp;
...
vk::Image DEngine::Gfx::Vk::DeviceDispatch::createImage(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorOutOfHostMemory:
	case vk::Result::eErrorOutOfDeviceMemory:
		throw std::runtime_error("Unable to create vk::Image.");
	default:
		break;
	}
	return temp;
...
vk::ImageView DEngine::Gfx::Vk::DeviceDispatch::createImageView(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorOutOfHostMemory:
	case vk::Result::eErrorOutOfDeviceMemory:
		throw std::runtime_error("Unable to create vk::ImageView.");
	default:
		break;
	}
	return temp;
...
vk::Sampler DEngine::Gfx::Vk::DeviceDispatch::createSampler(
	...
	vk::Optional<vk::AllocationCallbacks const> allocator) const
{
	...
	case vk::Result::eErrorOutOfHostMemory:
	case vk::Result::eErrorOutOfDeviceMemory:
		throw std::runtime_error("Unable to create vk::Sampler");
	default:
		break;
	}
	return temp;
...
void DEngine::Gfx::Vk::DeviceDispatch::updateDescriptorSets(
