...
namespace DEngine::Gfx::Vk
{
	...
	DeviceDispatchRaw DeviceDispatchRaw::Build(vk::Device inDevice, PFN_vkGetDeviceProcAddr getDeviceProcAddr)
	{
        ...
        returnVal.vkGetFenceFdKHR = PFN_vkGetFenceFdKHR(getDeviceProcAddr(device, "vkGetFenceFdKHR"));
        ...
        returnVal.vkGetMemoryFdKHR = PFN_vkGetMemoryFdKHR(getDeviceProcAddr(device, "vkGetMemoryFdKHR"));
        returnVal.vkGetMemoryFdPropertiesKHR = PFN_vkGetMemoryFdPropertiesKHR(getDeviceProcAddr(device, "vkGetMemoryFdPropertiesKHR"));
        ...
        returnVal.vkGetSemaphoreFdKHR = PFN_vkGetSemaphoreFdKHR(getDeviceProcAddr(device, "vkGetSemaphoreFdKHR"));
        returnVal.vkInitializePerformanceApiINTEL = PFN_vkInitializePerformanceApiINTEL(getDeviceProcAddr(device, "vkInitializePerformanceApiINTEL"));
        ...
        returnVal.vkMergeValidationCachesEXT = PFN_vkMergeValidationCachesEXT(getDeviceProcAddr(device, "vkMergeValidationCachesEXT"));
        returnVal.vkRegisterDeviceEventEXT = PFN_vkRegisterDeviceEventEXT(getDeviceProcAddr(device, "vkRegisterDeviceEventEXT"));
        returnVal.vkRegisterDisplayEventEXT = PFN_vkRegisterDisplayEventEXT(getDeviceProcAddr(device, "vkRegisterDisplayEventEXT"));
        returnVal.vkRegisterObjectsNVX = PFN_vkRegisterObjectsNVX(getDeviceProcAddr(device, "vkRegisterObjectsNVX"));
        returnVal.vkReleasePerformanceConfigurationINTEL = PFN_vkReleasePerformanceConfigurationINTEL(getDeviceProcAddr(device, "vkReleasePerformanceConfigurationINTEL"));
        returnVal.vkReleaseProfilingLockKHR = PFN_vkReleaseProfilingLockKHR(getDeviceProcAddr(device, "vkReleaseProfilingLockKHR"));
        ...
        returnVal.vkResetQueryPoolEXT = PFN_vkResetQueryPoolEXT(getDeviceProcAddr(device, "vkResetQueryPoolEXT"));
        returnVal.vkSetDebugUtilsObjectNameEXT = PFN_vkSetDebugUtilsObjectNameEXT(getDeviceProcAddr(device, "vkSetDebugUtilsObjectNameEXT"));
        returnVal.vkSetDebugUtilsObjectTagEXT = PFN_vkSetDebugUtilsObjectTagEXT(getDeviceProcAddr(device, "vkSetDebugUtilsObjectTagEXT"));
        returnVal.vkSetEvent = PFN_vkSetEvent(getDeviceProcAddr(device, "vkSetEvent"));
        returnVal.vkSetHdrMetadataEXT = PFN_vkSetHdrMetadataEXT(getDeviceProcAddr(device, "vkSetHdrMetadataEXT"));
        returnVal.vkSetLocalDimmingAMD = PFN_vkSetLocalDimmingAMD(getDeviceProcAddr(device, "vkSetLocalDimmingAMD"));
        returnVal.vkSignalSemaphoreKHR = PFN_vkSignalSemaphoreKHR(getDeviceProcAddr(device, "vkSignalSemaphoreKHR"));
        returnVal.vkTrimCommandPool = PFN_vkTrimCommandPool(getDeviceProcAddr(device, "vkTrimCommandPool"));
        returnVal.vkTrimCommandPoolKHR = PFN_vkTrimCommandPoolKHR(getDeviceProcAddr(device, "vkTrimCommandPoolKHR"));
        returnVal.vkUninitializePerformanceApiINTEL = PFN_vkUninitializePerformanceApiINTEL(getDeviceProcAddr(device, "vkUninitializePerformanceApiINTEL"));
        returnVal.vkUnmapMemory = PFN_vkUnmapMemory(getDeviceProcAddr(device, "vkUnmapMemory"));
        returnVal.vkUnregisterObjectsNVX = PFN_vkUnregisterObjectsNVX(getDeviceProcAddr(device, "vkUnregisterObjectsNVX"));
        ...
        returnVal.vkUpdateDescriptorSetWithTemplateKHR = PFN_vkUpdateDescriptorSetWithTemplateKHR(getDeviceProcAddr(device, "vkUpdateDescriptorSetWithTemplateKHR"));
        ...
        returnVal.vkWaitSemaphoresKHR = PFN_vkWaitSemaphoresKHR(getDeviceProcAddr(device, "vkWaitSemaphoresKHR"));
        returnVal.vkGetQueueCheckpointDataNV = PFN_vkGetQueueCheckpointDataNV(getDeviceProcAddr(device, "vkGetQueueCheckpointDataNV"));
        returnVal.vkQueueBeginDebugUtilsLabelEXT = PFN_vkQueueBeginDebugUtilsLabelEXT(getDeviceProcAddr(device, "vkQueueBeginDebugUtilsLabelEXT"));
        returnVal.vkQueueBindSparse = PFN_vkQueueBindSparse(getDeviceProcAddr(device, "vkQueueBindSparse"));
        returnVal.vkQueueEndDebugUtilsLabelEXT = PFN_vkQueueEndDebugUtilsLabelEXT(getDeviceProcAddr(device, "vkQueueEndDebugUtilsLabelEXT"));
        returnVal.vkQueueInsertDebugUtilsLabelEXT = PFN_vkQueueInsertDebugUtilsLabelEXT(getDeviceProcAddr(device, "vkQueueInsertDebugUtilsLabelEXT"));
        returnVal.vkQueuePresentKHR = PFN_vkQueuePresentKHR(getDeviceProcAddr(device, "vkQueuePresentKHR"));
        returnVal.vkQueueSetPerformanceConfigurationINTEL = PFN_vkQueueSetPerformanceConfigurationINTEL(getDeviceProcAddr(device, "vkQueueSetPerformanceConfigurationINTEL"));
