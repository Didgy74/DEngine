...
Engine::BoxCollider2D::~BoxCollider2D()
{
}

Math::Matrix3x3 Engine::BoxCollider2D::GetModel2D(Space space) const
{
...
Math::Matrix<3, 2> Engine::BoxCollider2D::GetModel2D_Reduced(Space space) const
{
...
Math::Matrix2x2 Engine::BoxCollider2D::GetRotationModel2D(Space space) const
{
...
Math::Matrix3x3 Engine::BoxCollider2D::GetRotationModel2D_Homo(Space space) const
{
	assert(space != Space::Local);
