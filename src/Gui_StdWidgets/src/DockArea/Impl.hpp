...
namespace DEngine::Gui::impl
{
	...
	struct DA_CustomData {
		...
		u32 tabTotalHeightPx = 0;
		u32 tabMarginPx = 0;
		u32 tabCornerRadiusPx = 0;
		Extent gizmoExtent = {};
		u32 resizeHandleThickness = 0;
		u32 resizeHandleLength = 0;
		u32 layerCornerRadiusPx = 0;
		u32 layerShadowFalloffPx = 0;
	};
	...
	using DA_ChildDispatchFnT = Std::FnRef<TouchEventConsumption(
		Widget&,
	...
	[[nodiscard]] TouchEventConsumption DA_PointerMove(
	...
	[[nodiscard]] TouchEventConsumption DA_PointerPress(
