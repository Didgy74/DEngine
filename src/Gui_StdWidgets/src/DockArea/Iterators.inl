...
namespace DEngine::Gui::impl
{
	...
	struct DA_Layer_It_Result_Inner
	{
		...
		[[nodiscard]] bool IsBackgroundLayer() const noexcept { return layerIndex == layerCount - 1; }
	...
	[[nodiscard]] DA_LayerItPair DA_BuildLayerItPairFrontToBack(DockArea& dockArea) noexcept;
	// Iterates front to back
	[[nodiscard]] DA_LayerConstItPair DA_BuildLayerItPairFrontToBack(DockArea const& dockArea) noexcept;
}
