...
#	define DENGINE_IMPL_APPLICATION_ASSERT(condition) DENGINE_IMPL_ASSERT(condition)
#	define DENGINE_IMPL_APPLICATION_ASSERT_MSG(condition, msg) DENGINE_IMPL_ASSERT_MSG(condition, msg)
